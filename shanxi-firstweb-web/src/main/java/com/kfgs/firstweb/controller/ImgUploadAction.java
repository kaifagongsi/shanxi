...
public class ImgUploadAction {
    ...
    private String imageFilePath = "E:\\Projects\\shanxi\\shanxi-firstweb-web\\src\\main\\webapp\\upload\\img\\";

    //@Value(value = "${ckeditor.storage.file.path}")
    private String filePath = "E:\\Projects\\shanxi\\shanxi-firstweb-web\\src\\main\\webapp\\upload\\file\\";

    //@Value(value = "${ckeditor.access.image.url}")
    private String url = "http://localhost:9101/upload/";
